...
//        }
    ...
    public function updateTransactionById(UpdateTransactionRequest $request):UpdateTransactionResponse
    {
        $this->transactionsRepository->updateTransactionById($request->transaction, $request->emailAdmin);
