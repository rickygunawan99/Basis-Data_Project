...
<main id="main" class="main">
    <form action="" method="GET">
        <?php $date = date("Y-m-d") ?>
        <h4>Update Info <?= $_GET['hari'] ?? ' '?> </h4>
        <div class="container d-flex align-items-center gap-2">
            <label class="mt-1">Hari
                <input type="date" name="hari" id="hari" value="<?=$_GET['hari'] ?? $date ?>">
            </label>
    ...
    <section class="section">
        <table class="table border-info">
            ...
            <tr>
                ...
                <th scope="col" class="fw-bold">Harga lama</th>
                <th scope="col" class="fw-bold">Harga baru</th>
                <th scope="col" class="fw-bold">Tanggal</th>
                <th scope="col" class="fw-bold">Diupdate oleh</th>
            </tr>
            </thead>
            <tbody>
            ...
            <?php } else { ?>
                <h4 class="mt-3 text-center">Update tidak ditemukan</h4>
            <?php } ?>
        </table>
    </section>
</main><!-- End #main -->
