    ...
    <div class="container d-flex flex-wrap gap-2">
        <div class="card" style="width: 18rem;">
            <div class="card-body">
                ...
                <p class="card-text fw-bold"><?= $model['info']['confirm'] ?? '0' ?></p>
            </div>
        </div>
        <div class="card" style="width: 18rem;">
            <div class="card-body ">
                <h5 class="card-title" style="color: red">Pembelian dibatalkan</h5>
                <p class="card-text fw-bold"><?= $model['info']['cancel'] ?? '0' ?></p>
            </div>
        </div>
        <div class="card" style="width: 18rem;">
            <div class="card-body ">
                <h5 class="card-title" style="color: blue">Menunggu konfirmasi</h5>
                <p class="card-text fw-bold"><?= $model['info']['waiting'] ?? '0' ?></p>
            </div>
        </div>
        <div class="card" style="width: 18rem;">
            <div class="card-body ">
                <h5 class="card-title" style="color: lightseagreen">Jumlah admin</h5>
                <p class="card-text fw-bold"><?= $model['info']['admin'] ?? '0' ?></p>
                <a href="/super/detail-admin" class="card-link" style="font-size: smaller">More info <i class="bi bi-arrow-right"></i> </a>
            </div>
        </div>
    </div>
</main><!-- End #main -->
