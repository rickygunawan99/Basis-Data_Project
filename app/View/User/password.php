    ...
    <form action="" method="POST">
        <div class="row pt-5 mb-sm-auto">
            <div class="col-md-3 col-sm-4 d-flex flex-column gap-2">
                ...
                <a class="btn btn-outline-primary active" href="/password">
                    <div class="profile d-flex align-items-center">
            ...
            <div class="col-md-6 col-sm-8">
                ...
                <div class="form-floating mb-3">
                    <input type="password" class="form-control" id="oldp" placeholder="id" name="oldpass">
                    <label for="oldp">Old Password</label>
                </div>
                <div class="form-floating mb-3">
                    <input name="newpass" type="password" class="form-control" id="newp" placeholder="old password">
                    <label for="newp">New Password</label>
                </div>
                <div class="form-floating mb-3">
                    <input name="confpass" type="password" class="form-control" id="confp" placeholder="password">
                    <label for="confp">Retype New Password</label>
                </div>
                <button class="w-25 btn btn-outline-success " type="submit">Save</button>
            </div>
        </div>
    </form>
