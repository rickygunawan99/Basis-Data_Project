...
use PHP\MVC\Middlewares\MustLoginSuperMiddleware;
...
Router::add("GET","/super",SuperAdminController::class,"dashboard", [MustLoginSuperMiddleware::class]);

Router::add("GET","/super/register-admin",SuperAdminController::class,"regisAdmin",[MustLoginSuperMiddleware::class]);
Router::add("POST","/super/register-admin",SuperAdminController::class,"postRegisAdmin", [MustLoginSuperMiddleware::class]);

Router::add("GET","/super/detail-admin",SuperAdminController::class,"detailAdmin",[MustLoginSuperMiddleware::class]);

Router::add("GET","/super/detail",SuperAdminController::class,"detail", [MustLoginSuperMiddleware::class]);
Router::add("GET","/super/detail-update",SuperAdminController::class,"detailUpdate", [MustLoginSuperMiddleware::class]);
